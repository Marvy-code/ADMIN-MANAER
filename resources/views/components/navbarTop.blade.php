<nav class="text-white main-header navbar navbar-expand navbar-white navbar-light" style='background-color: #005C94'>
    <!-- Left navbar links -->
    <ul class="navbar-nav">
      <li class="nav-item">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="i{{ route('home') }}" class="text-white nav-link">Accueil</a>
      </li>
      {{-- <li class="nav-item d-none d-sm-inline-block">
