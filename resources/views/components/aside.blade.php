    ...
    <div class="card" style='background-color: #005C94'>
        <div class="card-body box-profile">
            <div class="text-center">
                <img class="profile-user-img img-fluid" style='border:none; border-radius: 5px'
                    src="{{ asset('img/logojpg.jpg') }}" alt="User profile picture">
            </div>

            <h6 class="text-center text-white profile-username">
              {{ Auth::user()->nom }} - {{ Auth::user()->prenom }}
            </h6>

            <p class="text-center text-white">
                <span>
                    {{Auth::user()->roles->implode("libelle", ' | ')}}
                </span> <br>
